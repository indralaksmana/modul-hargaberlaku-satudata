<?php namespace Satudata\Hargaberlaku;

use Illuminate\Support\ServiceProvider;
use Satudata\Hargaberlaku\Console\Commands\HargaberlakuCommand;
...
class HargaberlakuServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton('hargaberlaku', function ($app) {
            return new Hargaberlaku;
        });

        $this->app->singleton('command.hargaberlaku', function ($app) {
            return new HargaberlakuCommand;
        });

        $this->commands('command.hargaberlaku');
    }
    ...
    protected function langHandle()
    {
        ...
        $this->publishes([
            $packageTranslationsPath => resource_path('lang/vendor/hargaberlaku'),
        ], 'lang');
    }
